...
public class ModItems {
    ...
    public static final RegistrySupplier<Item> PITCH = ITEMS.register(Bushcraft.id("pitch"),
            () -> new Item(new Item.Properties().arch$tab(CreativeModeTabs.INGREDIENTS)));
    public static final RegistrySupplier<Item> MULCH = ITEMS.register(Bushcraft.id("mulch"),
            () -> new Item(new Item.Properties().arch$tab(CreativeModeTabs.INGREDIENTS)));
    public static final RegistrySupplier<Item> PULP = ITEMS.register(Bushcraft.id("pulp"),
            () -> new Item(new Item.Properties().arch$tab(CreativeModeTabs.INGREDIENTS)));
    public static final RegistrySupplier<Item> WICKER = ITEMS.register(Bushcraft.id("wicker"),
            () -> new Item(new Item.Properties().arch$tab(CreativeModeTabs.INGREDIENTS)));
