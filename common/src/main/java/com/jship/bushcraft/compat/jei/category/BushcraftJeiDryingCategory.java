...
public class BushcraftJeiDryingCategory extends AbstractRecipeCategory<DryingRecipe> {

    public static final int width = 82;
    public static final int height = 40;

    public BushcraftJeiDryingCategory(IGuiHelper guiHelper) {
        super(BushcraftJeiPlugin.DRYING_RECIPE, Component.translatable("gui.jei.category.bushcraft.drying"), guiHelper.createDrawableItemLike(ModBlocks.DRYING_RACK.get()), width, height);
    }
